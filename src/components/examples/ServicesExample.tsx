...
const ServicesExample = () => {
  ...
  const handleNumberUtils = () => {
    ...
    const discountedPrice = services.number.calculateDiscountedPrice(
      price,
      discount
    );
    const formattedPrice = services.number.formatPrice(price);
    const formattedDiscountedPrice =
      services.number.formatPrice(discountedPrice);
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-gray-600 mb-3">
            Muestra diferentes tipos de notificaciones usando el servicio
            centralizado.
          </p>
          <LoadingButton
