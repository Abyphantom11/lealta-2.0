...
export function useMenu() {
  ...
  const saveCategory = useCallback(
    async (category: CategoryFormData): Promise<MenuOperationResult> => {
      setLoading(true);
      try {
  ...
  const deleteCategory = useCallback(
    async (id: string): Promise<MenuOperationResult> => {
      setLoading(true);
      try {
  ...
  const saveProduct = useCallback(
    async (product: ProductFormData): Promise<MenuOperationResult> => {
      setLoading(true);
      try {
  ...
  const uploadProductImage = useCallback(
    async (file: File, productId: string): Promise<string> => {
      setLoading(true);
      try {
