...
import { ArrowLeft, FileText, Shield, Globe } from 'lucide-react';
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="relative" style={{ paddingBottom: '75%' }}>
              <iframe
                src="https://www.termsfeed.com/live/fe733ddd-127d-4c4e-92b1-04648f07c8e0"
          ...
          >
            <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6">
              ...
              <p className="text-gray-500 text-xs mt-2">
                Para consultas sobre estos términos, contacta a: legal@lealta.com
              </p>
            </div>
          </motion.div>
        </div>
