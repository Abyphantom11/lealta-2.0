        ...
        try {
          ...
          if (options.showSuccessMessage !== false) {
            notificationService.success({
              ...
              message:
                options.successMessage || 'Formulario enviado correctamente.',
            });
          }
...
export const validationRules = {
  ...
  email:
    (message = 'Correo electrónico inválido'): ValidationRule<string> =>
    value => {
  ...
  numeric:
    (message = 'Este campo debe ser numérico'): ValidationRule<string> =>
    value => {
      if (!value) return null;
